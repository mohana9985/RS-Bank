...
class Bank:
    ...
    def reg(self):
        ...
        b2 = Button(self.main, text="Cancel", command=self.main.destroy)
    ...
    def ver(self):
        try:
            con = pymysql.connect(host="localhost", user="root", password="rootroot", db="bank")
            cur = con.cursor()
    ...
    def acc(self):
        ...
        # Account Page
        self.ac = Tk()
        self.ac.geometry("550x300+450+150")
    ...
    def rem(self):
        ...
        b2 = Button(self.rm, text="Back", command=self.rb)
    ...
    def info(self):
        ...
        b1.place(x=300, y=50)
        b2 = Button(self.io, text="Back", command=self.aib)
    ...
    def depo(self):
        ...
        b1.place(x=400, y=75)
        b2 = Button(self.dp, text="Back", command=self.db)
    ...
    def withdraw(self):
        ...
        b1.place(x=400, y=75)
        b2 = Button(self.wd, text="Back", command=self.wb)
        b2.place(x=100, y=350)
    ...
    def accopen(self):
        ...
        l6.place(x=200, y=50)
        l7=Label(self.ao,text="(yyyy-mm-dd)")
        l7.place(x=100,y=220)
        # Button
        b1 = Button(self.ao, text="Sumbit", command=self.accosuc)
        b1.place(x=300, y=325)
        b2 = Button(self.ao, text="Back", command=self.aob)
    ...
    def accsum(self):
        ...
        # Button
        b1 = Button(self.am, text="Back", command=self.ab)
